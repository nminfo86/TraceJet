...
class OfController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $of = Of::with("caliber:id,product_id")->findOrFail($id, ["caliber_id", "status", "quantity", "new_quantity"]);
    ...
    public function getOfDetails($id)
    {
        ...
        $of_info = Of::join('calibers', 'ofs.caliber_id', 'calibers.id')
            ...
            ->find($id, ["calibers.caliber_name", "products.product_name", "ofs.created_at", "ofs.of_number", "ofs.quantity", "ofs.new_quantity", 'ofs.status']);
