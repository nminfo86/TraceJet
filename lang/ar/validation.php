...
return [
    ...
    "are_you_sure_you_want_to_delete_member" => "هل أنت متأكد من رغبتك بحذف عضو الفريق هذا؟",
    "are_you_sure_you_want_to_delete_team" => "هل أنت متأكد من رغبتك بحذف هذا الفريق؟",
    "are_you_sure_you_want_to_leave_team" => "هل أنت متأكد من رغبتك بمغادرة هذا الفريق؟",
    ...
    "between" => [
        ...
        "numeric" => "يجب أن يكون عدد حروف نّص حقل :attribute بين :min و :max.",
        "string"=>"يجب أن يكون عدد حروف نّص حقل :attribute بين :min و :max."
    ],
    "boolean"=> "يجب أن تكون قيمة حقل :attribute إما true أو false .",
    "confirmed"=> "حقل التأكيد غير مُطابق للحقل :attribute.",
    "country"=> "الحقل :attribute لا يمثل دولة صالحة.",
    ...
    "gt" => [
        ...
        "string" => "يجب أن يكون طول نص حقل :attribute أكثر من :value حروفٍ/حرفًا.",
    ],
    "gte" => [
    ...
    "if_you_delete_team_all_data_will_be_deleted"=> "إذا اخترت حذف الفريق، فسيتم حذف جميع البيانات بشكل دائم.",
    ...
    "leave_team"=> "مغادة الفريق",
    "looks_like_you_are_not_part_of_team"=> "يبدو أنك لا تنتمي إلى أي فريق!",
    ...
    "next"=> "التالي &raquo;",
    "not_eligible_based_on_current_members_teams"=> "أنت لست مؤهلاً لهذه الخطة بناءً على عدد فرقك / أعضاء فريقك.",
    ...
    "plan_allows_no_more_teams"=> "خطتك الحالية لا تسمح لك بإنشاء المزيد من الفرق",
    ...
    "slug_input_explanation"=> "يتم استخدام الرابط الصديق هذا لتحديد فريقك في عناوين URL.",
    "starts_with"=> "يجب أن يبدأ حقل :attribute بأحد القيم التالية: :values",
    "state"=> "هذه الولاية غير صالحة ضمن الدولة المحددة.",
    "string"=> "يجب أن يكون حقل :attribute نصًا.",
    "team"=> "فريق",
    "team_billing"=> "فوترة الفريق",
    "team_members"=> "أعضاء الفريق",
    "team_name"=> "اسم الفريق",
    "team_name_was_updated"=> "تم تحديث اسم الفريق الخاص بك!",
    "team_photo"=> "صورة الفريق",
    "team_profile"=> "الملف الشخصي للفريق",
    "team_settings"=> "إعدادات الفريق",
    "team_slug"=> "العنوان الصديق للفريق",
    "team_trial"=> "تجربة الفريق",
    "team_trial_will_expire_on"=> "ستنتهي الفترة التجريبية للفريق في :date.",
    "teams"=> "الفرق",
    "teams_currently_trialing"=> "فرق قيد التجربة",
    ...
    "user_already_invited_to_team"=> "تم دعوة هذا المستخدم مسبقاً لهذا الفريق.",
    "user_already_on_team"=> "هذا المستخدم منضم لهذا الفريق بالفعل.",
    "user_doesnt_belong_to_team"=> "المستخدم لا ينتمي إلى الفريق المحدد.",
    "user_invited_to_join_team"=> "=>UserName قام بدعوتك للإنضمام إلى فريقه!",
    "uuid"=> "حقل :attribute يجب أن يكون بصيغة UUID سليمة.",
    "vat_id"=> "رقم تعريف ضريبة القيمة المضافة هذا غير صالح.",
    "view_all_teams"=> "عرض جميع الفرق",
    "we_found_invitation_to_team"=> "لقد عثرنا على دعوتك للفريق :teamName!",
    "wheres_your_team"=> "أين فريقك؟",
    ...
    'attributes' => [
        ...
        'roles_name' => 'الدور',
        'section_id' => 'القسم',
        'section_code' => 'رمز القسم',
        'section_name' => 'اسم القسم',
        'product_code' => 'الكود',
        'product_id' => 'المنتج',
        'product_name' => 'المنتج',
        'caliber_code' => 'الكود',
        'caliber_name' => 'الكاليبر',
        'caliber_id' => 'الكاليبر',
        'box_quantity' => 'كمية الصندوق',
        'quantity' => 'الكمية',
        'new_quantity' => 'الكمية الإجمالية لأمر التصنيع',
        'code' => 'الكود',
        'post_name' => 'اسم المنصب',
        'posts_type_id' => 'نوع المنصب',
        'ip_address' => 'عنوان IP',
    ],
];
