!(function() {
    ...
    var p = "beforeend",
        ...
        d = function(t, e, n, r) {
            ...
            try {
                for (
                    var f, m = n[Symbol.iterator](); !(c = (f = m.next()).done); c = !0
                ) {
                    var v = f.value;
                    a.insertAdjacentElement(
                        ...
                        ((l = v.value),
                            ...
                            (o = v.selected),
                            (d = void 0),
                            ((d = document.createElement("option")).innerText = i),
                            l && d.setAttribute("value", l),
                            o && d.setAttribute("selected", o),
                            d)
                    );
                }
            } catch (e) {
        ...
        r = function(e, t) {
            ...
            return (
                ...
                o.insertAdjacentElement(
                    p,
                    c("bold", "Bold", s("fas fa-bold"), t)
                ),
                e.italic !== u &&
                o.insertAdjacentElement(
                    p,
                    c("italic", "Italic", s("fas fa-italic"), t)
                ),
                e.underline !== u &&
                o.insertAdjacentElement(
                    p,
                    c("underline", "Underline", s("fas fa-underline"), t)
                ),
                e.forecolor !== u &&
                o.insertAdjacentElement(
                    p,
                ...
                o.insertAdjacentElement(p, f()),
                e.justifyleft !== u &&
                o.insertAdjacentElement(
                    p,
                    c("justifyleft", "Left align", s("fas fa-align-left"), t)
                ),
                e.justifycenter !== u &&
                o.insertAdjacentElement(
                    p,
                    c("justifycenter", "Center align", s("ti-align-justify"), t)
                ),
                e.justifyright !== u &&
                o.insertAdjacentElement(
                    p,
                    c("justifyright", "Right align", s("fas fa-align-right"), t)
                ),
                o.insertAdjacentElement(p, f()),
                e.insertorderedlist !== u &&
                o.insertAdjacentElement(
                    p,
                    c(
                        "insertorderedlist",
                ...
                o.insertAdjacentElement(
                    ...
                    c(
                        "outdent",
                        "Decrease indent",
                        s("fas fa-indent fa-flip-horizontal"),
                        t
                    )
                ),
                e.indent !== u &&
                o.insertAdjacentElement(
                    p,
                    c("indent", "Increase indent", s("fas fa-indent"), t)
                ),
                o.insertAdjacentElement(p, f()),
                e.removeFormat !== u &&
                o.insertAdjacentElement(
                    p,
                    c("removeFormat", "Clear formatting", s("fas fa-eraser"), t)
                ),
                o
            );
        };
    ...
    document.querySelectorAll("#data-tiny-editor").forEach(function(n) {
        ...
        var t = function() {
            ...
            try {
                for (
                    var a,
                        ...
                        i = e[Symbol.iterator](); !(t = (a = i.next()).done); t = !0
                )
                    l();
            } catch (e) {
                (n = !0), (r = e);
            ...
            try {
                for (
                    var u, f = o[Symbol.iterator](); !(d = (u = f.next()).done); d = !0
                ) {
                    var m = u.value,
            ...
            var p,
                ...
                x,
                E,
                b = C.querySelectorAll("input[data-command-id]"),
                h = !0,
                g = !1,
                A = void 0;
            try {
                for (
                    var j, _ = b[Symbol.iterator](); !(h = (j = _.next()).done); h = !0
                ) {
                    var S = j.value,
                    ...
                    S.value =
                        ((E = void 0),
                            ...
                            (y = parseInt(p[2])),
                            (x = parseInt(p[3])),
                            (E = parseInt(p[4]) | (x << 8) | (y << 16)),
                            p[1] + "#" + E.toString(16).padStart(6, "0"));
                }
            } catch (e) {
                (g = !0), (A = e);
            } finally {
